...
class Ui_Settings_Window(object):
    def setupUi(self, MainWindow):
        ...
        self.Fon.setText("")
        self.Fon.setPixmap(QtGui.QPixmap("4.png"))
...
"}")
    ...
    def openBackgroundSelection(self):
        # Диалоговое окно для выбора фона
        ...
        self.button1.setStyleSheet(r"QPushButton {background-image: url('dlack.jpg');}")
        self.button1.clicked.connect(lambda: self.changeBackground('dlack.jpg'))
        layout.addWidget(self.button1)

        self.button2 = QtWidgets.QPushButton(self.dialog)
        self.button2.setStyleSheet(r"QPushButton {background-image: url('gray.jpg');}")
        self.button2.clicked.connect(lambda: self.changeBackground('gray.jpg'))
        layout.addWidget(self.button2)

        self.button3 = QtWidgets.QPushButton(self.dialog)
        self.button3.setStyleSheet(r"QPushButton {background-image: url('red.jpg');}")
        self.button3.clicked.connect(lambda: self.changeBackground('red.jpg'))
        layout.addWidget(self.button3)
        
        self.button4 = QtWidgets.QPushButton(self.dialog)
        self.button4.setStyleSheet(r"QPushButton {background-image: url('pink.jpg');}")
        self.button4.clicked.connect(lambda: self.changeBackground('pink.jpg'))
        layout.addWidget(self.button4)
        
        self.button5 = QtWidgets.QPushButton(self.dialog)
        self.button5.setStyleSheet(r"QPushButton {background-image: url('blue.jpg');}")
        self.button5.clicked.connect(lambda: self.changeBackground('blue.jpg'))
        layout.addWidget(self.button5)
        
        self.button6 = QtWidgets.QPushButton(self.dialog)
        self.button6.setStyleSheet(r"QPushButton {background-image: url('gray-black.jpg');}")
        self.button6.clicked.connect(lambda: self.changeBackground('gray-black.jpg'))
        layout.addWidget(self.button6)
        
        self.button7 = QtWidgets.QPushButton(self.dialog)
        self.button7.setStyleSheet(r"QPushButton {background-image: url('black.jpg');}")
        self.button7.clicked.connect(lambda: self.changeBackground('black.jpg'))
