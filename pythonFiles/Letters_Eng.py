...
class Ui_Letters_Eng(QtCore.QObject):
    def setupUi(self, MainWindow):
        super(Ui_Letters_Eng, self).__init__()
        ...
        self.text_to_type = 'a a a aaaaa b b b b babababa uuu u u u eeeee ee b b ee ee ff cy fci fci fy fy tsyf tsyf i iii it it it ti ti b u'
        ...
        if obj == self.VvodTexta and event.type() == QtCore.QEvent.KeyPress:
            if not self.is_paused and not self.is_exercise_completed:
                ...
                if input_text == self.text_to_type[:len(input_text)]:
                    ...
                    self.show_next_key_image()
        return super(Ui_Letters_Eng, self).eventFilter(obj, event)
